...
:::caution
If you are trying to read this sensor from the ESP32, use the "DHT sensor library for ESPx" library. Other DHT22 libraries may not work reliably on the ESP32. You can use this [example project](https://wokwi.com/arduino/projects/322410731508073042) as a starting point.
:::
...
- [DHT22 on the ESP32](https://wokwi.com/arduino/projects/322410731508073042)
