...
| --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AVR                               | ATmega328P ([Arduino Uno](../parts/wokwi-arduino-uno), [Arduino Nano](../parts/wokwi-arduino-nano)), ATmega2560 ([Arduino Mega](../parts/wokwi-arduino-mega)), [ATtiny85](../parts/wokwi-attiny85) |
| [ESP32](../guides/esp32)          | **Xtensa**: ESP32, ESP32-S2, ESP32-S3<br /> **RISC-V**: ESP32-C3, ESP32-C5\*, ESP32-C6, ESP32-C61, ESP32-H2, ESP32-P4, ESP32-S31\*                                                                 |
| STM32                             | [STM32C031](../parts/board-st-nucleo-c031c6), [STM32L031](../parts/board-st-nucleo-l031k6), [STM32F103C8](../parts/board-stm32-bluepill.md)                                                        |
| [Pi Pico](../parts/wokwi-pi-pico) | RP2040 (Raspberry Pi Pico), a dual-core ARM Cortex-M0+ microcontroller                                                                                                                             |
...
| [DS18B20 Temperature Sensor](../parts/wokwi-ds18b20)                     | One-Wire digital temperature sensor                                                                       |
| [BMP180](../parts/board-bmp180)                                          | Barometric pressure and temperature sensor with I2C interface                                             |
...
| [MQ2 Gas Sensor](../parts/wokwi-gas-sensor)                              | Analog gas sensor for detecting combustible gases (LPG, Propane, Methane, etc.)                           |
| [HX711 Load Cell](../parts/wokwi-hx711)                                  | HX711 Load Cell Amplifier with 5kg/50kg/gauge load cell                                                   |
| [MFRC522 RFID Reader](../parts/board-mfrc522)                            | RFID/NFC reader module with SPI interface for reading 13.56 MHz MIFARE cards                              |

## Input devices

| Part                                                      | Description                                                                                                        |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| [Pushbutton](../parts/wokwi-pushbutton)                   | 12mm Tactile Switch Button (momentary push button), also available in [6mm variant](../parts/wokwi-pushbutton-6mm) |
...
| [WS2812 LED](../parts/wokwi-neopixel)         | NeoPixel Compatible LED                            |
| [WS2812 LED Ring](../parts/wokwi-led-ring)    | NeoPixel Compatible LED Ring                       |
...
| [Nokia 5110 Screen](../parts/wokwi-nokia-5110-screen)          | Monochrome 84x48 pixel LCD display with SPI interface      |
...
| [SH1107 OLED](../parts/board-grove-oled-sh1107)                | Monochrome 128x128 OLED display with I2C interface         |
...
| [Clock Generator](../parts/wokwi-clock-generator) | Configurable clock signal generator     |
...
| [Text](../parts/wokwi-text)                       | Text annotation element for diagrams    |
